    ...
    public partial class librarian : Form
    {
        ...
        private void guna2Button5_Click(object sender, EventArgs e)
        {
            ...
            string.IsNullOrWhiteSpace(validIdFile))
                ...
                string fileQuery = @"INSERT INTO librarian_files (diplomaFile, licenseFile, transcriptFile, valididFile) VALUES (@diplomaFile, @licenseFile, @transcriptFile, @validIdFile)";
